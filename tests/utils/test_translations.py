...
def test_home_translation_keys_exist():
    ...
    required_keys = [
        ...
        "home_queue_ocr_label",
        "home_queue_ocr_tooltip",
        ...
        "settings_ocr_provider_label",
        "settings_ocr_provider_legacy",
        "settings_ocr_provider_glmocr",
        "settings_glmocr_group",
        "settings_ocr_fallback_label",
        "settings_glmocr_mode_label",
        "settings_glmocr_mode_maas",
        "settings_glmocr_mode_ollama",
        "settings_glmocr_mode_sdk_server",
        "settings_glmocr_mode_custom",
        "settings_glmocr_mode_server",
        "settings_glmocr_mode_direct",
        "settings_glmocr_mode_selfhosted",
        "settings_glmocr_ollama_note",
        "settings_glmocr_ollama_host_label",
        "settings_glmocr_ollama_host_placeholder",
        "settings_glmocr_ollama_port_label",
        "settings_glmocr_ollama_model_label",
        "settings_glmocr_ollama_model_placeholder",
        "settings_glmocr_sdk_server_note",
        "settings_glmocr_sdk_server_url_label",
        "settings_glmocr_sdk_server_url_placeholder",
        "settings_glmocr_custom_note",
        "settings_glmocr_server_note",
        "settings_glmocr_server_url_label",
        "settings_glmocr_server_url_placeholder",
        "settings_glmocr_direct_note",
        "settings_glmocr_api_host_label",
        "settings_glmocr_api_port_label",
        "settings_glmocr_model_label",
        "settings_glmocr_config_path_label",
        "settings_glmocr_config_path_dialog",
        "settings_legacy_ocr_group",
        ...
        "yaml_files_filter",
        "help_open_glmocr",
        "help_open_glmocr_self_host",
        "help_open_glmocr_ollama",
