...
def test_home_translation_keys_exist():
    ...
    required_keys = [
        ...
        "settings_pdf_group",
        "settings_pdf_pipeline_label",
        "settings_pdf_pipeline_tooltip",
        "settings_pdf_pipeline_markitdown",
        "settings_pdf_pipeline_pymupdf",
        "settings_preserve_pdf_images_label",
        "settings_preserve_pdf_images_tooltip",
        "settings_pdf_assets_layout_label",
        "settings_pdf_assets_layout_tooltip",
        "settings_pdf_assets_layout_separate",
        "settings_pdf_assets_layout_single",
