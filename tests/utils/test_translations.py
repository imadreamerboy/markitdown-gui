...
def test_home_translation_keys_exist():
    ...
    required_keys = [
        ...
        "home_preserve_docx_images_label",
        "home_preserve_docx_images_tooltip",
        "home_preserve_images_note",
        ...
        "clear_list_action",
        "settings_ocr_group",
        "settings_save_to_source_folder_label",
        "settings_save_to_source_folder_tooltip",
        "settings_ocr_enable_label",
        "settings_ocr_provider_label",
        "settings_ocr_provider_azure_tesseract",
        ...
        "settings_azure_tesseract_ocr_group",
