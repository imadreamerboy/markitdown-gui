...
TRANSLATIONS = {
    "en": {
        ...
        "theme_system": "System",
        "help_title": "Help",
        "help_description": "Quick access to updates, shortcuts, and project links.",
        ...
        "doc_intel_tooltip": "Enter your Azure Document Intelligence endpoint. Set AZURE_API_KEY for API-key auth, or use Azure identity credentials.",
        ...
        "settings_docintel_tooltip": "Optional. When set, OCR will try Azure first for supported PDFs and image files. Set AZURE_API_KEY for API-key auth, or use Azure identity credentials.",
    ...
    "zh_CN": {
        ...
        "theme_system": "跟随系统",
        "help_title": "帮助",
        "help_description": "快速访问更新、快捷键和项目链接。",
        ...
        "doc_intel_tooltip": "如果要使用 Azure 文档智能，请输入其终结点。若使用 API Key，请设置 `AZURE_API_KEY`；否则可使用 Azure 身份凭据。",
        "settings_ocr_group": "OCR",
        ...
        "settings_docintel_placeholder": "https://<resource>.cognitiveservices.azure.com/",
        "settings_docintel_tooltip": "可选。设置后，支持的 PDF 和图片会先尝试 Azure OCR。若使用 API Key，请设置 `AZURE_API_KEY`；否则可使用 Azure 身份凭据。",
