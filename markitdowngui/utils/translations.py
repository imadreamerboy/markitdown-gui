...
TRANSLATIONS = {
    "en": {
        ...
        "settings_tesseract_path_tooltip": "Optional full path to the Tesseract binary for local OCR fallback.",
    ...
    "zh_CN": {
        ...
        "settings_tesseract_path_tooltip": "可选。本地 OCR 回退时使用的 Tesseract 完整路径。",
