...
TRANSLATIONS = {
    "en": {
        ...
        "settings_docintel_tooltip": "Optional. When set, OCR will try Azure first for supported PDFs and image files.",
    ...
    "zh_CN": {
        ...
        "settings_docintel_placeholder": "https://<resource>.cognitiveservices.azure.com/",
        "settings_docintel_tooltip": "可选。设置后，支持的 PDF 和图片会先尝试 Azure OCR。",
