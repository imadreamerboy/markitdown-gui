...
TRANSLATIONS = {
    "en": {
        ...
        "home_supported_formats": "Supported formats: docx, pptx, xlsx/xls, pdf, epub, html, txt, csv, json, xml, zip",
    ...
    "zh_CN": {
        ...
        "home_supported_formats": "支持格式: docx, pptx, xlsx/xls, pdf, epub, html, txt, csv, json, xml, zip",
